...
def vg_generator(data, batch_size, n_labelled):
    images = data
...
def load(batch_size, test_batch_size, n_labelled=None):
    ...
    return (
        vg_generator(train_data, batch_size, n_labelled),
        vg_generator(dev_data, test_batch_size, n_labelled),
        vg_generator(test_data, test_batch_size, n_labelled)
    )


def read_colormnist_data():
    train_dir = '/local-scratch/cjc/GenerativeNeuralModuleNetwork/data/VG/VG-train/cropped_images'
    test_dir = '/local-scratch/cjc/GenerativeNeuralModuleNetwork/data/VG/VG-train/cropped_images'
